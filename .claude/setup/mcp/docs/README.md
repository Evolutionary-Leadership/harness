...
| [mcp-server.md](./architecture/mcp-server.md) | The MCP endpoint: its surface, the protocol revision and request shape, the OAuth authorization chain, the shipped tool, and the generated OAuth tables |
...
| [0007](./decisions/0007-serve-mcp-modern-only-with-per-user-oauth.md) | Serve MCP modern-only, authorized per user by this app's own OAuth | Accepted | 2026-08-22 |
