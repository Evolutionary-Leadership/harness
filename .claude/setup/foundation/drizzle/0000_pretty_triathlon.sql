...
CREATE UNIQUE INDEX "notebooks_user_id_name_key" ON "notebooks" USING btree ("user_id","name");--> statement-breakpoint
CREATE INDEX "notes_scope_idx" ON "notes" USING btree ("user_id","notebook_id","archived","position");--> statement-breakpoint
CREATE INDEX "notes_notebook_id_idx" ON "notes" USING btree ("notebook_id");